...
#for showing signup/login button for admin(by Naveen)
...
#for showing signup/login button for doctor(by Naveen)
...
#for showing signup/login button for patient(by Naveen)
...
#-----------for checking user is doctor , patient or admin(by Naveen)
def is_admin(user):
...
#Developed By : Naveen Upadhyay
#facebook : fb.com/Naveen.upadhyay
#Youtube :youtube.com/c/Greyhat127
